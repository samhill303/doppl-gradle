...
NSString *AndroidOsBundle_asdf = @"asdf";
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "asdf", "LNSString;", .constantValue.asLong = 0, 0x19, -1, 101, -1, -1 },
    { "mMap_", "LJavaUtilMap;", .constantValue.asLong = 0, 0x0, -1, -1, 102, -1 },
