...
/**
 * Just a placeholder. Todo: remove method bodies (possibly methods)
 */
public final class Parcel {
    ...
    private int mObject; // used by code
    @SuppressWarnings({"UnusedDeclaration"})
    private int mOwnObject; // used by code
    ...
    /*package*/ static FileDescriptor openFileDescriptor(String file,
            int mode) throws FileNotFoundException
    {
        throw new UnsupportedOperationException();
    }
    /*package*/ static void closeFileDescriptor(FileDescriptor desc)
            throws IOException
    {
        throw new UnsupportedOperationException();
    }
    ...
    public final void readByteArray(byte[] val) {
        // TODO: make this a method to avoid the extra copy.
