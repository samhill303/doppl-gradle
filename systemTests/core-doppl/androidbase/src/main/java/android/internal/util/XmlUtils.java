...
public class XmlUtils
{
    ...
    //Make sure they're in the static library build
    private static Class[] hardref = new Class[]{org.kxml2.io.KXmlParser.class,org.kxml2.io.KXmlSerializer.class};
}
