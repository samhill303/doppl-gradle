...
public final class SQLiteConnection {
    ...
    private static native Object nativeOpen(String path, int openFlags, String label, boolean enableTrace, boolean enableProfile)/*-[
    ...
    private static native void nativeBindNull(Object connectionPtr, Object statementPtr,
            int index)/*-[
            [SQLiteConnectionNative nativeBindNull:connectionPtr statement:statementPtr index:index];
    ]-*/;
    private static native void nativeBindLong(Object connectionPtr, Object statementPtr,
            int index, long value)/*-[
        [SQLiteConnectionNative nativeBindLong:connectionPtr statement:statementPtr index:index value:value];
    ]-*/;
    private static native void nativeBindDouble(Object connectionPtr, Object statementPtr,
            int index, double value)/*-[
        [SQLiteConnectionNative nativeBindDouble:connectionPtr statement:statementPtr index:index value:value];
    ]-*/;
    private static native void nativeBindString(Object connectionPtr, Object statementPtr,
            int index, String value)/*-[
        [SQLiteConnectionNative nativeBindString:connectionPtr statement:statementPtr index:index value:value];
    ]-*/;
    private static native void nativeBindBlob(Object connectionPtr, Object statementPtr,
    ...
    private static native void nativeResetStatementAndClearBindings(
            Object connectionPtr, Object statementPtr)/*-[
...
*/
    ...
    private void setPageSize() {
        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
            ...
            long value = executeForLong("PRAGMA page_size", null);
            if (value != newValue) {
    ...
    private void setAutoCheckpointInterval() {
        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
            ...
            long value = executeForLong("PRAGMA wal_autocheckpoint", null);
            if (value != newValue) {
    ...
    private void setJournalSizeLimit() {
        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
            ...
            long value = executeForLong("PRAGMA journal_size_limit", null);
            if (value != newValue) {
    ...
    private void setForeignKeyModeFromConfiguration() {
        if (!mIsReadOnlyConnection) {
            ...
            long value = executeForLong("PRAGMA foreign_keys", null);
            if (value != newValue) {
    ...
    private void setSyncMode(String newValue) {
        String value = executeForString("PRAGMA synchronous", null);
    ...
    private void setJournalMode(String newValue) {
        String value = executeForString("PRAGMA journal_mode", null);
        if (!value.equalsIgnoreCase(newValue)) {
            try {
                String result = executeForString("PRAGMA journal_mode=" + newValue, null);
...
//        nativeRegisterLocalizedCollators(mConnectionPtr, newLocale);
    ...
    void dumpUnsafe(Printer printer, boolean verbose) {
        ...
        if (verbose) {
            printer.println("  connectionPtr: 0x" + mConnectionPtr);
        }
