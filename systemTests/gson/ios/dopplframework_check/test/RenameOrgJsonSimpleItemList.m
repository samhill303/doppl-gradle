...
#include "RenameOrgJsonSimpleItemList.h"
#include "java/lang/StringBuffer.h"
#include "java/util/ArrayList.h"
#include "java/util/List.h"
#include "java/util/StringTokenizer.h"

@interface RenameOrgJsonSimpleItemList () {
 @public
  NSString *sp_;
}
...
J2OBJC_FIELD_SETTER(RenameOrgJsonSimpleItemList, sp_, NSString *)

@implementation RenameOrgJsonSimpleItemList

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  RenameOrgJsonSimpleItemList_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (instancetype)initWithNSString:(NSString *)s {
  RenameOrgJsonSimpleItemList_initWithNSString_(self, s);
  return self;
}

- (instancetype)initWithNSString:(NSString *)s
                    withNSString:(NSString *)sp {
  RenameOrgJsonSimpleItemList_initWithNSString_withNSString_(self, s, sp);
  return self;
}
...
- (instancetype)initWithNSString:(NSString *)s
  ...
  RenameOrgJsonSimpleItemList_initWithNSString_withNSString_withBoolean_(self, s, sp, isMultiToken);
  return self;
}
...
- (void)addAllWithRenameOrgJsonSimpleItemList:(RenameOrgJsonSimpleItemList *)list {
  [((id<JavaUtilList>) nil_chk(items_)) addAllWithJavaUtilCollection:((RenameOrgJsonSimpleItemList *) nil_chk(list))->items_];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[11].selector = @selector(addAllWithRenameOrgJsonSimpleItemList:);
  ...
  static const void *ptrTable[] = { "LNSString;", "LNSString;LNSString;", "LNSString;LNSString;Z", "split", "LNSString;LNSString;LJavaUtilList;Z", "LNSString;LNSString;LJavaUtilList;", "setSP", "add", "ILNSString;", "addAll", "LRenameOrgJsonSimpleItemList;", "get", "I", "toString" };
  static const J2ObjcClassInfo _RenameOrgJsonSimpleItemList = { "ItemList", "rename.org.json.simple", ptrTable, methods, fields, 7, 0x1, 21, 2, -1, -1, -1, -1, -1 };
  return &_RenameOrgJsonSimpleItemList;
}

@end

void RenameOrgJsonSimpleItemList_init(RenameOrgJsonSimpleItemList *self) {
  NSObject_init(self);
  JreStrongAssign(&self->sp_, @",");
  JreStrongAssignAndConsume(&self->items_, new_JavaUtilArrayList_init());
}

RenameOrgJsonSimpleItemList *new_RenameOrgJsonSimpleItemList_init() {
  J2OBJC_NEW_IMPL(RenameOrgJsonSimpleItemList, init)
}

RenameOrgJsonSimpleItemList *create_RenameOrgJsonSimpleItemList_init() {
  J2OBJC_CREATE_IMPL(RenameOrgJsonSimpleItemList, init)
}

void RenameOrgJsonSimpleItemList_initWithNSString_(RenameOrgJsonSimpleItemList *self, NSString *s) {
  NSObject_init(self);
  JreStrongAssign(&self->sp_, @",");
  JreStrongAssignAndConsume(&self->items_, new_JavaUtilArrayList_init());
...
RenameOrgJsonSimpleItemList *new_RenameOrgJsonSimpleItemList_initWithNSString_(NSString *s) {
  J2OBJC_NEW_IMPL(RenameOrgJsonSimpleItemList, initWithNSString_, s)
}

RenameOrgJsonSimpleItemList *create_RenameOrgJsonSimpleItemList_initWithNSString_(NSString *s) {
  J2OBJC_CREATE_IMPL(RenameOrgJsonSimpleItemList, initWithNSString_, s)
}

void RenameOrgJsonSimpleItemList_initWithNSString_withNSString_(RenameOrgJsonSimpleItemList *self, NSString *s, NSString *sp) {
  NSObject_init(self);
  JreStrongAssign(&self->sp_, @",");
  JreStrongAssignAndConsume(&self->items_, new_JavaUtilArrayList_init());
...
RenameOrgJsonSimpleItemList *new_RenameOrgJsonSimpleItemList_initWithNSString_withNSString_(NSString *s, NSString *sp) {
  J2OBJC_NEW_IMPL(RenameOrgJsonSimpleItemList, initWithNSString_withNSString_, s, sp)
}

RenameOrgJsonSimpleItemList *create_RenameOrgJsonSimpleItemList_initWithNSString_withNSString_(NSString *s, NSString *sp) {
  J2OBJC_CREATE_IMPL(RenameOrgJsonSimpleItemList, initWithNSString_withNSString_, s, sp)
}

void RenameOrgJsonSimpleItemList_initWithNSString_withNSString_withBoolean_(RenameOrgJsonSimpleItemList *self, NSString *s, NSString *sp, jboolean isMultiToken) {
  NSObject_init(self);
  JreStrongAssign(&self->sp_, @",");
  JreStrongAssignAndConsume(&self->items_, new_JavaUtilArrayList_init());
...
RenameOrgJsonSimpleItemList *new_RenameOrgJsonSimpleItemList_initWithNSString_withNSString_withBoolean_(NSString *s, NSString *sp, jboolean isMultiToken) {
  J2OBJC_NEW_IMPL(RenameOrgJsonSimpleItemList, initWithNSString_withNSString_withBoolean_, s, sp, isMultiToken)
}

RenameOrgJsonSimpleItemList *create_RenameOrgJsonSimpleItemList_initWithNSString_withNSString_withBoolean_(NSString *s, NSString *sp, jboolean isMultiToken) {
  J2OBJC_CREATE_IMPL(RenameOrgJsonSimpleItemList, initWithNSString_withNSString_withBoolean_, s, sp, isMultiToken)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RenameOrgJsonSimpleItemList)
