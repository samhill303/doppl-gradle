...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source_files = FileList["build/testdoppllib.h"].include("build/dopplBuild/dependencies/out/main/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/source/out/main/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/dependencies/out/test/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/source/out/test/**/*.{h,m,cpp,properites,txt}").include("build/classes/main/**/*.java").include("build/generated/source/apt/main/**/*.java").include("src/main/java/**/*.java").include("build/classes/test/**/*.java").include("build/generated/source/apt/test/**/*.java").include("src/test/java/**/*.java").to_ary
